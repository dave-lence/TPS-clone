...
export default function IssuesStories() {
  return (
...
const stories = [
    {
      ...
      },
      {
          ...
          image: "https://cdn-adchm.nitrocdn.com/eZehlnEhyRUIGTheitFZhEcdCZwkLROW/assets/images/optimized/rev-e3547e4/wp-content/uploads/2020/04/jobskin-1024x485.jpg",
        },
        {
            name: "Bronsens",
