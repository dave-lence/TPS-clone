...
export default function CommunicationKeepUpToDate() {
  return (
    <section id="keep-up-t-date" className="my-10 mt-20">
      <div className="min-h-screen px-6 md:px-10">
        <div className="flex flex-col space-y-5 md:flex-row md:space-x-10">
          ...
          <div className="border-2 w-full md:w-1/2 border-blue-100 p-10 rounded ">
            ...
            <div className="flex items-center md:px-0 flex-row mb-10 space-x-3 md:space-x-7">
              <input
                type="text"
          ...
          <div className="p-10 w-full md:w-1/2 bg-blue-950 shadow-xl  text-white rounded">
            ...
            <div>
              <p className="text-2xl font-bold text-left">
                ...
                maintenance costs. We’ve seen a huge increase in efficiency from
                working in a virtualised environment along with peace of mind
                that our systems are fully backed up at all times.
              </p>
