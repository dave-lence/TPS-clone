      ...
      <div className="container relative z-10">
        <div className="flex flex-col space-y-5 lg:flex-row lg:items-stretch">
          ...
          <div className="w-full lg:w-1/2 px-5 mb-7 lg:mb-0">
            <div className="relative overflow-hidden h-full border-2 rounded border-primary100">
              <div className="relative p-7 sm:p-9 text-left">
                ...
                <p className="text-xl text-primary-dark pb-12">
          ...
          <div className="w-full lg:w-1/2 px-5 order-last">
            <div className="relative h-full p-[1.875rem] sm:p-16 bg-primary rounded">
              ...
              <div>
                ...
                <p className="mt-4 mb-10 text-left text-white">
                  Marks Winsk, Head of IT, St. Pauls Cathedral
                </p>
              </div>
            </div>
          </div>
