...
const CyberStories = (props: Props) => {
  return (
    <section className='bg-gradient-to-b from-[#f2f5fa] to-white py-11'>
      <div className="container">
        <h4 className='text-primary-dark font-bold text-[2rem] lg:text-[2.65rem]'>Related Success Stories</h4>
